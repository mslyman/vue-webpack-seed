    ...
    "babel-eslint": "^8.2.3",
    "babel-loader": "^7.1.4",
    "babel-preset-env": "^1.7.0",       // enables es2015 import in vue-loader
    
    "copy-webpack-plugin": "^4.5.1",    // provides static content copy (src/static -> dist/static) 
    "cross-env": "^5.1.6",              // provides cross-platform send environment variable NODE_ENV=development into webpack.config.js
    ...
    "file-loader": "^1.1.11",           // loads small image files into .js (inline content), big image files into dist/images. 
                                        ...
                                        // example 3: style background: url('./../src/images/webpack.png') no-repeat; background-size: contain;
